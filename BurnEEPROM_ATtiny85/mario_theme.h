...
static const uint16_t PauseSound[] =
{
  NOTE_E6, NOTE_C6,NOTE_E6, NOTE_C6
  };

static const uint8_t PauseSound_Durations[] =
{
  16,16,16,16
};
...
static const uint16_t Melody_Intro[]PROGMEM = 
{
...
static const uint8_t NoteDurations_Intro[] PROGMEM= 
{ 
  8, 8, 8, 8,
  8, 8, 8, 8,
  8, 4, 8,
